        ...
        {METRICS.map((m) => (
          <button
            ...
            style={
              metric === m.key
                ? {
                    backgroundColor: m.selectedColor,
                    borderColor: m.selectedColor,
                  }
                : {}
            }
          >
          ...
          <div className="island-shell rounded-2xl px-3 pb-3 pt-4">
            <div className="mb-3 flex items-baseline justify-between px-1">
              <span
                ...
                style={{ color: activeMetric.selectedColor }}
              >
              ...
              <div className="flex items-center gap-3">
                ...
                {(metric === "calories" ||
                  (metric === "protein" && macroGoals.protein) ||
                  (metric === "carbs" && macroGoals.carbs) ||
                  (metric === "fat" && macroGoals.fat)) && (
                  <div className="flex items-center gap-1">
                    <svg width="16" height="4" viewBox="0 0 16 4">
                      <line
                        ...
                        x2="16"
                        y2="2"
                        stroke={activeMetric.selectedColor}
                        strokeWidth="1.5"
                        strokeDasharray="4 3"
                        opacity="0.6"
                      />
            ...
            <SvgBarChart
              ...
              goalValue={
                metric === "calories"
                  ? goal
                  : metric === "protein"
                    ? (macroGoals.protein ?? undefined)
                    : metric === "carbs"
                      ? (macroGoals.carbs ?? undefined)
                        ...
                        style={
                          isActive
                            ? {
                                ...
                                outline: `1px solid ${selectedColor}`,
                              }
                            : {}
                        }
                      >
                        <span
                          className="text-sm font-bold"
                          style={{
                            color: isActive ? selectedColor : "var(--sea-ink)",
                          }}
                        >
                          {key === "calories"
                            ? Math.round(val)
